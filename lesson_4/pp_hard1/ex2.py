class FuelEfficiencyMixin:
    ...
    def set_fuel_efficiency(self, kilometers_per_liter):
        self.fuel_effficiency = kilometers_per_liter

    def set_fuel_capacity(self, liters_of_fuel_capacity):
        self.fuel_capacity = liters_of_fuel_capacity

class WheeledVehicle(FuelEfficiencyMixin):
    def __init__(self,
                 tire_list, kilometers_per_liter, liters_of_fuel_capacity):
...
class Boat(FuelEfficiencyMixin):
